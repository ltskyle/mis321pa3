...
namespace mis321pa3.database
{
    public class GetSongs : IGetAllSongs
    {
        public List<Song> GetAllSongs()
        {
            ...
            while (rdr.Read()) {
                Song temp = new Song(){SongID=rdr.GetString(0), Title=rdr.GetString(1), Artist=rdr.GetString(2), DateAdded=rdr.GetString(3), Favorited=rdr.GetString(4), Deleted=rdr.GetString(5)};
